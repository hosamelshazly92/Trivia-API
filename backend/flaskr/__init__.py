...
def create_app(test_config=None):
    ...
    '''
    @TODO_DONE: Set up CORS. Allow '*' for origins. Delete the sample route
    ...
    '''
    @TODO_DONE: Create an endpoint to handle GET requests for all available
    categories.
    '''
    ...
    '''
    @TODO_DONE: Create an endpoint to handle GET requests for questions,
    ...
    '''
    @TODO_DONE: Create an endpoint to DELETE question using a question ID.
    ...
    '''
    @TODO_DONE: Create an endpoint to POST a new question, which will require
    ...
    and the question will appear at the end of the last page of the questions
    ...
    '''
    @TODO_DONE: Create a POST endpoint to get questions based on a search term.
    It should return any questions for whom the search term is a substring
    of the question.

    TEST: Search by any phrase. The questions list will update to include only
    question that include that string within their question. Try using the word
    "title" to start.
    '''
    ...
    '''
    @TODO_DONE: Create a GET endpoint to get questions based on category.

    TEST: In the "List" tab / main screen, clicking on one of the categories in
    the left column will cause only questions of that category to be shown.
    '''
    ...
    '''
    @TODO_DONE: Create a POST endpoint to get questions to play the quiz. This
    endpoint should take category and previous question parameters and return
    a random questions within the given category, if provided, and that is not
    ...
    '''
    @TODO_DONE: Create error handlers for all expected errors including 404
    and 422.
    '''
